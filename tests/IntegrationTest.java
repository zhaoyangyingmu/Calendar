...
public class IntegrationTest {
    ...
    public static Collection<Object[]> getTestData() {
        return Arrays.asList(new Object[][]{
                {"2018-5-1", "2018-4-29", false, false, false, Item.ItemType.LEISURE},     //非法时间段，不能创建待办事项对象
                {"2018-1-1", "2017-12-30", false, false, false, Item.ItemType.LEISURE},    //非法时间段
                {"2016-2-30", "2016-3-1", true, false, false, Item.ItemType.LEISURE},      //非法日期
                {"2000-2-29", "2018-2-29", false, true, false, Item.ItemType.LEISURE},     //非法日期
                {"2020-2-29", "2020-3-0", false, true, false, Item.ItemType.LEISURE},      //非法日期
                {"0000-00-00", "2018-5-12", true, false, false, Item.ItemType.LEISURE},    //非法日期
                {"2018-2-29", "2018-4-29", false, false, false, Item.ItemType.LEISURE},    //非法日期
                {"2018-2-28", "2018-3-1", false, false, true, Item.ItemType.LEISURE},
                {"2000-2-29", "2018-2-29", false, false, true, Item.ItemType.STUDY},
                {"2020-2-29", "2018-4-1", false, false, true, Item.ItemType.DATING},
                {"2018-5-10", "2018-5-12", false, false, true, Item.ItemType.LEISURE},
                {"2018-5-9", "2018-5-11", false, false, true, Item.ItemType.STUDY},
                {"2018-5-10", "2018-5-12", false, false, true, Item.ItemType.DATING},
        });
    }
    ...
    public void ItemTest() {
        ...
        Item item;
        if (type == Item.ItemType.LEISURE) {
            item = new OtherItem(frTime, toTime, "", type);
        } else if (type == Item.ItemType.DATING)
            item = new Appointment(frTime, toTime, "", type, "", "");
        else
            item = new Meeting(frTime, toTime, "", type, "", "");
